<%@ Page Title="" Language="C#" MasterPageFile="~/Super-Manager/MasterPage_SM.master" AutoEventWireup="true" CodeFile="BookcaseManage.aspx.cs" Inherits="Super_Manager_BookcaseManage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="main2">
        <asp:Button ID="Button1" runat="server" Text="+添加书架类型" CssClass="add" 
            onclientclick="window.open('addBookcase.aspx?bookcaseID=add','','width=500,height=550');"  BorderColor="White" />
        <asp:GridView ID="Bookcase" runat="server" AutoGenerateColumns="False" AllowPaging="True"  Width="930px"  CssClass="gv"
            GridLines="None" PageSize="6" CellPadding="4" BackColor="White" ForeColor="Black" 
             OnRowDeleting="Bookcase_RowDeleting"  OnPageIndexChanging="Bookcase_PageIndexChanging" >
            <Columns>
                <asp:BoundField DataField="bookcaseID" HeaderText="书架ID"  InsertVisible="False" ReadOnly="True" />

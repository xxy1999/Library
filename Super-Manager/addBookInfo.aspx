...
<body>
    ...
    <div>
        ...
        <asp:TextBox ID="txtBarCode" runat="server" CssClass="tb" Width="150px"></asp:TextBox><br />
        ...
        <asp:TextBox ID="txtAuthor" runat="server"  Width="150px" CssClass="tb"></asp:TextBox><br />
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidatorBookconcern" runat="server"
          ControlToValidate="txtBookConcern" ErrorMessage="*"></asp:RequiredFieldValidator><br />

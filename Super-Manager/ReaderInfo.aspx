<%@ Page Title="" Language="C#" MasterPageFile="~/Super-Manager/MasterPage_SM.master" AutoEventWireup="true" CodeFile="ReaderInfo.aspx.cs" Inherits="Super_Manager_ReaderInfo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="main2">
        <asp:Button ID="Button1" runat="server" Text="+添加读者信息" CssClass="add" 
            onclientclick="window.open('addReaderInfo.aspx?readerBarCode=add','','width=500,height=700');" 
            BorderColor="White" />     
        <div style="overflow-x:auto;">
        <asp:GridView ID="gvReaderInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False" 
            Width="1100px" CssClass="gv" GridLines="None" PageSize="6" CellPadding="4" OnRowDeleting="gvReaderInfo_RowDeleting"
              onrowdatabound="gvReaderInfo_RowDataBound" onpageindexchanging="gvReaderInfo_PageIndexChanging">
            <Columns>
                ...
                <asp:TemplateField HeaderText="修改">
                    <ItemTemplate>
                    <a href="#"  onclick="window.open('addReaderInfo.aspx?readerBarCode=<%#Eval("readerBarCode") %>','','width=500,height=650')"
                     class="change">修改</a>
                    </ItemTemplate>
                </asp:TemplateField>

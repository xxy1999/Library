<%@ Page Title="" Language="C#" MasterPageFile="~/Manager/MasterPage_M.master" AutoEventWireup="true" CodeFile="BookType.aspx.cs" Inherits="Manager_BookType" %>
         ...
         OnPageIndexChanging="gvBookType_PageIndexChanging"  CssClass="gv">
            <Columns>
                ...
                <asp:TemplateField HeaderText="修改">
                    <ItemTemplate>
                        <a href="#" class="change" onclick="window.open('addBookType.aspx?id=<%#Eval("typeID") %>','','width=300,height=180')">修改</a>
                    </ItemTemplate>
                </asp:TemplateField>

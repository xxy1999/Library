...
public partial class Manager_BookBorrowSearch : System.Web.UI.Page
{
    static string sql = "";
    ...
    public void bindBookBorrow(string seSql, string getisReturn)
    {
        gvBookBorrow.DataSource = dataOperate.getDataset(seSql + getisReturn, "tb_bookBorrow");
    ...
    public string getisReturn()
    {
        ...
        else if (rdibtn1.Checked)   //已还图书信息
        {

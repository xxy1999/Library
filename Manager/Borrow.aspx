<%@ Page Title="" Language="C#" MasterPageFile="~/Manager/MasterPage_M.master" AutoEventWireup="true" CodeFile="Borrow.aspx.cs" Inherits="Manager_Borrow" %>
          ...
          ForeColor="#333333" GridLines="None" PageSize="5" Width="930px" AutoGenerateColumns="False" 
           OnSelectedIndexChanging="gvBookBorrow_SelectedIndexChanging">
            <Columns>
                ...
                <asp:CommandField HeaderText="借阅" SelectText="借阅" ShowSelectButton="True" ItemStyle-ForeColor="#1890FF"/>
            </Columns>

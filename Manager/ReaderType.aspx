<%@ Page Title="" Language="C#" MasterPageFile="~/Manager/MasterPage_M.master" AutoEventWireup="true" CodeFile="ReaderType.aspx.cs" Inherits="Manager_ReaderType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="main2">
        <asp:Button ID="Button1" runat="server" Text="+添加读者类型" CssClass="add" 
            onclientclick="window.open('addReaderType.aspx?id=add','','width=500,height=380');" 
            BorderColor="White" />
        ...
        <asp:GridView ID="gvReaderType" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="修改">
                    <ItemTemplate>
                        <a href="#" class="change" 
                        onclick="window.open('addReaderType.aspx?id=<%#Eval("id") %>','','width=500,height=380')">修改</a>
                    </ItemTemplate>
                </asp:TemplateField>

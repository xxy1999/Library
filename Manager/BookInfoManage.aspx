<%@ Page Title="" Language="C#" MasterPageFile="~/Manager/MasterPage_M.master" AutoEventWireup="true" CodeFile="BookInfoManage.aspx.cs" Inherits="Manager_BookInfoManage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="main2">
        <asp:Button ID="Button1" runat="server" Text="+添加图书信息" CssClass="add" 
            onclientclick="window.open('addBookInfo.aspx?ID=add','','width=500,height=550,,menubar=no,toolbars=no,location=no,directories=no,scrollbar=no,status=no,resizable=no');" 
            BorderColor="White" />
